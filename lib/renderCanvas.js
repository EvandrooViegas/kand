...
function estimateTextHeight(text, node) {
  ...
  // Use a slightly wider average glyph estimate so we err on the side of MORE
  // lines (taller box). A generous height prevents grouped nodes from overlapping
  // the next member when Satori wraps text onto an extra line.
